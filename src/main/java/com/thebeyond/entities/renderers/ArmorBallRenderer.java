...
@OnlyIn(Dist.CLIENT)
public class ArmorBallRenderer extends EntityRenderer<ArmorBall> {
    ...
    public ArmorBallRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }


    protected int getBlockLightLevel(ArmorBall pEntity, BlockPos pPos) {
        return 15;
    }

    public void render(ArmorBall pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
     ...
     */
    public ResourceLocation getTextureLocation(ArmorBall pEntity) {
