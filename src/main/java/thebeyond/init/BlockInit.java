...
public class BlockInit {
    ...
    public static final RegistryObject<Block> EXAMPLE_BLOCK = register("ExampleBlock", () -> new Block(AbstractBlock.Properties.of(Material.DECORATION).strength(2).harvestTool(ToolType.AXE).sound(SoundType.ANCIENT_DEBRIS)));
